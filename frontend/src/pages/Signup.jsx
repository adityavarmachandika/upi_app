...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Left panel with enhanced gradient and visual elements */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 justify-center items-center relative overflow-hidden">
        ...
        <div className="relative z-10 px-16 text-white max-w-lg">
          <div className="mb-8">
            ...
            <h1 className="text-5xl font-extrabold mb-6 tracking-tight">Join Our Platform</h1>
            <p className="text-xl font-light leading-relaxed opacity-90">Create an account to send and receive money instantly with our secure platform.</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-white px-6 md:px-12 py-12 shadow-xl">
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-gray-800 tracking-tight">Create an account</h2>
            <p className="text-gray-500 mt-3">Enter your details to get started</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full flex justify-center py-3.5 px-4 border border-transparent rounded-lg shadow-md text-white font-medium bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 ease-in-out `}
            >
              Create account
            </button>
          </form>
